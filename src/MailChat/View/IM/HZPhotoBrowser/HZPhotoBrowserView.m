...
- (void)handleLongTap:(UILongPressGestureRecognizer *)recognizer
{
    ...
    {
        UIAlertView *alertView =[[UIAlertView alloc] initWithTitle:PMLocalizedStringWithKey(@"PM_IMAGE_SaveImageToAlbum") message:nil delegate:self cancelButtonTitle:PMLocalizedStringWithKey(@"PM_Common_Cancel") otherButtonTitles:PMLocalizedStringWithKey(@"PM_Common_Sure"), nil];
        [alertView show];
    }
}
...
- (void)image: (UIImage *) image didFinishSavingWithError: (NSError *) error contextInfo: (void *) contextInfo
{
    ...
    [[[UIAlertView alloc] initWithTitle:nil message:msg delegate:nil cancelButtonTitle:PMLocalizedStringWithKey(@"PM_Common_Sure") otherButtonTitles:nil, nil] show];
}
