...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [MCChatTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    ...
    return [MCChatTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [MCChatTextView maxCharactersPerLine]) + 1;
}
