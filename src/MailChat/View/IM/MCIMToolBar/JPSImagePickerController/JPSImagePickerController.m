...
- (void)addCancelButton {
    ...
    [self.cancelButton setTitle:PMLocalizedStringWithKey(@"PM_Common_Cancel") forState:UIControlStateNormal];
...
- (void)addRetakeButton {
    ...
    [self.retakeButton setTitle:PMLocalizedStringWithKey(@"PM_IMChat_retake") forState:UIControlStateNormal];
...
- (void)addUseButton {
    ...
    [self.useButton setTitle:PMLocalizedStringWithKey(@"PM_IMChat_usePhoth") forState:UIControlStateNormal];
