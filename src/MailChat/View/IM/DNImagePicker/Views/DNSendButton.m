...
#define kSendButtonFont  [UIFont systemFontOfSize:16]

static NSString *const dnSendButtonTintAbnormalColor = @"C9EFCA";

static CGFloat const kSendButtonTextWitdh = 42.0f;
...
- (void)setupViews
{
    ...
    _backGroudView.backgroundColor = AppStatus.theme.tintColor;;
    ...
    _badgeValueLabel.font = kSendButtonFont;
    ...
    [_sendButton setTitleColor:AppStatus.theme.tintColor forState:UIControlStateNormal];
    [_sendButton setTitleColor:[UIColor colorWithHexString:dnSendButtonTintAbnormalColor] forState:UIControlStateHighlighted];
    [_sendButton setTitleColor:[UIColor colorWithHexString:dnSendButtonTintAbnormalColor] forState:UIControlStateDisabled];
...
{
    _title = title;
    [_sendButton setTitle:self.title?:NSLocalizedStringFromTable(@"send", @"DNImagePicker", @"发送")
