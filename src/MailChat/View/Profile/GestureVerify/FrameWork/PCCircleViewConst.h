 ...
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor  [UIColor colorWithHexString:@"8c939b"]//rgba(241,241,241,1)

/**
 *  选中状态下外空心圆颜色
 */
#define CircleStateSelectedOutsideColor [UIColor clearColor] //rgba(34,178,246,1)
 ...
 *  普通状态下外实心圆的颜色
 */
#define CircleStateNormalOutsolidColor [UIColor clearColor]
/**
 *  选中状态下外实心圆颜色
 */
#define CircleStateSelectedOutsolidColor [UIColor colorWithHexString:@"a5d8fc"]
 ...
 *  选中状态下内实心圆颜色
 */
#define CircleStateSelectedInsideColor [UIColor colorWithHexString:@"44b3ff"]
...
#define gestureTextBeforeSet PMLocalizedStringWithKey(@"PM_Mine_SetingGesturePassword")

/**
 *  设置时，连线个数少，提示文字
 */
#define gestureTextConnectLess [NSString stringWithFormat:@"请至少连接%d个点", CircleSetCountLeast]

/**
 *  确认图案，提示再次绘制
 */
#define gestureTextDrawAgain PMLocalizedStringWithKey(@"PM_Mine_SettingAgainGesturePassword")

/**
 *  再次绘制不一致，提示文字
 */
#define gestureTextDrawAgainError PMLocalizedStringWithKey(@"PM_Mine_SetGestureDifferent")

/**
 *  设置成功
 */
#define gestureTextSetSuccess PMLocalizedStringWithKey(@"PM_Mine_SetGestureSuccess")


/**
 *  请输入原手势密码
 */
#define gestureTextOldGesture PMLocalizedStringWithKey(@"PM_Mine_OldGesture")

/**
 *  密码错误
 */
#define gestureTextGestureVerifyError PMLocalizedStringWithKey(@"PM_Mine_GestureError")
#define gestureTextGestureVerifyErrorCoount 5
