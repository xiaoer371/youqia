...
//TODO:修改搜索
+ (MCOIMAPSearchExpression *) searchFrom:(NSString *)value withSearchType:(int)search35Type
{
    return MCO_TO_OBJC(mailcore::IMAPSearchExpression::searchFrom([value mco_mcString], search35Type));
}
...
+ (MCOIMAPSearchExpression *) searchSubject:(NSString *)value withSearchType:(int)searchType
{
    return MCO_TO_OBJC(mailcore::IMAPSearchExpression::searchSubject([value mco_mcString], searchType));
}
...
+ (MCOIMAPSearchExpression *) searchOr:(MCOIMAPSearchExpression *)expression other:(MCOIMAPSearchExpression *)other withSearchType:(int)type
{
    mailcore::IMAPSearchExpression * result = mailcore::IMAPSearchExpression::searchOr(expression->_nativeExpr, other->_nativeExpr, type);
