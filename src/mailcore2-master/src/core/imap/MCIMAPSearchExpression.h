...
namespace mailcore {
    ...
    public:
        ...
        virtual int  searchFor35Type(); //TODO: 增加35邮箱搜索类型参数
        ...
        static IMAPSearchExpression * searchFrom(String * value, int searchFor35Type);//TODO:mark
        ...
        static IMAPSearchExpression * searchSubject(String * value, int searchFor35Type);//TODO:mark
        ...
        static IMAPSearchExpression * searchOr(IMAPSearchExpression * left, IMAPSearchExpression * right, int searchFor35Type);//TODO:mark
        static IMAPSearchExpression * searchNot(IMAPSearchExpression * notExpr);
        static IMAPSearchExpression * setSearchFor35Type(uint32_t type);//TODO:增加35搜索类型
    ...
    private:
        ...
        int mSearch35Type;//TODO:增加35搜索邮箱类型
        IndexSet * mUids;
        IndexSet * mNumbers;
