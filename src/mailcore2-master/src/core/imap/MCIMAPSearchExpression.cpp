...
IMAPSearchExpression::IMAPSearchExpression(IMAPSearchExpression * other)
{
    ...
    mSearch35Type = other->mSearch35Type;//TODO :增加35邮箱类型判断
...
//TODO:mark
IMAPSearchExpression * IMAPSearchExpression::searchFrom(String * value, int search35Type)
{
    IMAPSearchExpression * expr = new IMAPSearchExpression();
    expr->mKind = IMAPSearchKindFrom;
    expr->mSearch35Type = search35Type;
...
//TODO:mark change
IMAPSearchExpression * IMAPSearchExpression::searchSubject(String * value, int search35Type)
{
    IMAPSearchExpression * expr = new IMAPSearchExpression();
...
//TODO:mark change
IMAPSearchExpression * IMAPSearchExpression::searchOr(IMAPSearchExpression * left, IMAPSearchExpression * right, int searchFor35Type)
{
    IMAPSearchExpression * expr = new IMAPSearchExpression();
    expr->mKind = IMAPSearchKindOr;
    expr->mSearch35Type = searchFor35Type;
    MC_SAFE_REPLACE_RETAIN(IMAPSearchExpression, expr->mLeftExpression, left);
    MC_SAFE_REPLACE_RETAIN(IMAPSearchExpression, expr->mRightExpression, right);
    return (IMAPSearchExpression *) expr->autorelease();
}
...
IMAPSearchExpression * IMAPSearchExpression::setSearchFor35Type(uint32_t type)//TODO:增加35搜索类型
{
    IMAPSearchExpression * expr = new IMAPSearchExpression();
    expr->mSearch35Type = type;
    return (IMAPSearchExpression *) expr->autorelease();
}
...
int IMAPSearchExpression::searchFor35Type()
{
    return mSearch35Type;
}
